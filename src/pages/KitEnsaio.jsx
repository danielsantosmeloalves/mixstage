...
export default function KitEnsaio({ session }) {
  ...
  const [precarregando, setPrecarregando] =
    useState(false)
  ...
  const [pitchAplicado, setPitchAplicado] =
    useState(0)
  ...
  function fmt(s) {
    ...
    return `${Math.floor(s / 60)}:${Math.floor(
      s % 60
    )
      .toString()
      .padStart(2, '0')}`
