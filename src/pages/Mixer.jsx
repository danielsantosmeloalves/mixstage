...
export default function Mixer({ session }) {
  ...
  function iniciarSources(offset) {
    ...
    // Todas as trilhas recebem exatamente o mesmo detune e playbackRate
    // — incluindo drums, click e guia — garantindo sincronia perfeita.
    // detune = semitons * 100 cents (muda pitch)
    // playbackRate = 2^(-semitons/12) (compensa velocidade causada pelo detune)
